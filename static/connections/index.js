            ...
            Northwind: {
                tables: {
                    customer: {
                        ...
                        data: [ // generate via faker if less
                            {
                                customerID: "ALFKI",
                        ...
                        queries: [
                            ...
                            'select * from customer where city=berlin limit 100',
                        ],
                    },
                    order: {
                        id: 2,
                        ...
                        queries: [
                            ...
                            'select * from order where productName=Chai limit 100',
                        ],
                    },
                    product: {
                        id: 3,
                        ...
                        queries: [
                            ...
                            'select * from product where discontinued gt 0 limit 100',
                        ],
                    },
                }
            },
